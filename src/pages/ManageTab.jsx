...
export default class ManageTab extends Tab {
    ...
    async componentDidMount() {
        let hash = new URL(document.URL).hash.substring(1);
        if (hash !== '') {
    ...
    render() {
        return (
            <div>
                ...
                {imalConnect.isConnected() ? <ManageNameTabs openTab={this.state.openNo}/> : <h1>Connect your wallet to manage your names!</h1>}
            </div>
    );
  }
}