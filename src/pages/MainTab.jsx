...
class MainTab extends React.Component {
    ...
    async componentDidMount() {
        ...
        if (stats.height !== 0) {
            this.setState({ currentHeight: stats.height, namesRegistered: stats.namesRegistered, transactionsMade: stats.transactionsMade });
        }
    }
    eventHandler = (stats) => {
        this.setState({ currentHeight: stats.height, namesRegistered: stats.namesRegistered, transactionsMade: stats.transactionsMade });
    ...
    render() {
        return (
            ...
            <div>
                ...
                <ItemDrawer/>
                <h1>Welcome to VinuPay! 👋 (0.4.5 - Don't cache update)</h1>
                <Container sx={{width: "100% !important", margin: "0 !important"}}>
                    <Grid2 container spacing={3} columnSpacing={{ xs: 1, sm: 1, md: 2, lg: 2, xl: 2}} justifyContent="center" alignItems="center" >
                        <Grid2 item>
